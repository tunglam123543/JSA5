...
let inputNamecar = document.querySelector("#inputNamecar");
...
btnChange.addEventListener("click" , function(){
    let carLocalStrorage = JSON.parse(localStorage.getItem("car"))
    console.log("Value từ input = " , + inputColor.value);
    carLocalStrorage.color = inputColor.value;

    localStorage.setItem("car", JSON.stringify(carLocalStrorage));
});
